...
{
    public class AcidNPC : GameplayMonoBehaviour<AcidNPC>
    {
        ...
        public void StartAcid()
        {
            ...
            state.ChangeState(NpcStates.Acid);

            //Instancia particulas
            activeVFX = particlesManager.InstantiateParticleInPos("Veneno", transform);
